...
#made_time
red_eye <- flights %>% 
  filter(sched_dep_time == 2400 | sched_dep_time <= 0600 )
#red_eye
...
flights_small <- flights %>% 
  select(dep_time, arr_time, arr_delay, dep_delay)
...
flights_big <- flights %>%
select(dep_time,dep_time, arr_time, arr_delay, dep_delay)
#Nothing, it will still display that variable once. 
```
